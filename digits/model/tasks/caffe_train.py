...
class CaffeTrainTask(TrainTask):
    ...
    def save_files_classification(self):
        ...
        print 'solver.snapshot =', solver.snapshot
        #assert (0)
    ...
    def task_arguments(self, resources, env):
        ...
        # This is the normal path
                ###########################################################################
        print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
        print config_value('caffe')['executable']
        # caffe_root = ''
        print 'change_caffe =', self.change_caffe
        # assert(0)
        if self.change_caffe == '2':
            config_value('caffe')['executable'] = '/home/mayang/zys/caffe_cuda_stream_demo/build/tools/caffe'
            # caffe_root = '/home/mayang/zys/caffe_cuda_stream_demo/'
        elif self.change_caffe == '1':
            config_value('caffe')['executable'] = '/home/mayang/zys/caffe_master_demo/build/tools/caffe'
            #caffe_root = '/home/mayang/zys/caffe_master_demo/'
        elif self.change_caffe == '0':
            config_value('caffe')['executable'] = '/home/mayang/caffe/build/tools/caffe'
        else:
            assert (0),'chang_caffe\'value must be 0, 1 or 2'
        # print config_value('caffe')['executable']
        # assert (0)
        ############################################################################
        args = [config_value('caffe')['executable'],
            ...
            # args.append('--solver=%s' % caffe_root+'examples/mnist/lenet_solver.prototxt')
         ##############################################################################
        if self.change_caffe == '2':
            args.append('--fragment=4')
            args.append('--stream=4')
    ##############################################################################
        if 'gpus' in resources:
            identifiers = []
