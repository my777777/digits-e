...
class TrainTask(Task):
    ...
    def __init__(self, job, dataset, train_epochs, snapshot_interval, learning_rate, lr_policy, **kwargs):
        ...
        """
        ###############################
        self.networkName = kwargs.pop('networkName', None)
        self.AlgorithmOpt = kwargs.pop('AlgorithmOpt', None)
        self.machine_select = kwargs.pop('machine_select',None)
        self.hostlist = kwargs.pop('hostlist', None)
        self.manualgrouping = kwargs.pop('manualgrouping',None)
        self.change_caffe = kwargs.pop('change_caffe',None)
        ###############################
